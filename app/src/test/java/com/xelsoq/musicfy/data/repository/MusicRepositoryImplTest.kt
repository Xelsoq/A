...
import com.xelsoq.musicfy.data.database.SongEntity // Necesario para datos de prueba
import com.xelsoq.musicfy.data.database.AlbumEntity
import com.xelsoq.musicfy.data.database.ArtistEntity
import com.xelsoq.musicfy.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.xelsoq.musicfy.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.xelsoq.musicfy.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.xelsoq.musicfy.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.xelsoq.musicfy.data.telegram.TelegramRepository> = mockk()
