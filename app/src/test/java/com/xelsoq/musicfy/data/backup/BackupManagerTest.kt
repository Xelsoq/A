...
import com.xelsoq.musicfy.data.backup.model.BackupModuleInfo
...
class BackupManagerTest {
        ...
        every { validationPipeline.validateFile(backupUri) } returns BackupValidationResult.Invalid(
            listOf(
                ValidationError(
                    ...
                    severity = com.xelsoq.musicfy.data.backup.model.Severity.WARNING
                )
            )
        )
    ...
    private fun restorePlan(
        ...
        return RestorePlan(
            ...
            backupUri = "content://musicfy/test-backup",
