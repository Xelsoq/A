...
import com.xelsoq.musicfy.data.diagnostics.AdvancedPerformanceDiagnosticsController
...
import com.xelsoq.musicfy.presentation.viewmodel.LibraryStateHolder
import com.xelsoq.musicfy.presentation.viewmodel.ThemeStateHolder
...
import com.xelsoq.musicfy.utils.MediaMetadataRetrieverPool
...
@HiltAndroidApp
class MusicfyApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.xelsoq.musicfy.data.image.TelegramCoilFetcher.Factory>

    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.xelsoq.musicfy.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.xelsoq.musicfy.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.xelsoq.musicfy.data.image.LocalArtworkCoilFetcher.Factory>
    ...
    companion object {
        const val NOTIFICATION_CHANNEL_ID = "musicfy_music_channel"
        lateinit var instance: MusicfyApplication
            private set
    }
    ...
    override fun onCreate() {
        ...
        startupScope.launch {
            AlbumArtUtils.migrateLegacyCacheLocation(this@MusicfyApplication)
