...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.xelsoq.musicfy.data.model.SortOption = com.xelsoq.musicfy.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.xelsoq.musicfy.data.model.SortOption = com.xelsoq.musicfy.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.xelsoq.musicfy.data.model.SortOption = com.xelsoq.musicfy.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.xelsoq.musicfy.data.model.SortOption = com.xelsoq.musicfy.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.xelsoq.musicfy.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.xelsoq.musicfy.data.model.StorageFilter = com.xelsoq.musicfy.data.model.StorageFilter.ALL
    ): Flow<List<com.xelsoq.musicfy.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.xelsoq.musicfy.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.xelsoq.musicfy.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.xelsoq.musicfy.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.xelsoq.musicfy.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.xelsoq.musicfy.data.telegram.TelegramRepository
