...
import com.xelsoq.musicfy.ui.glancewidget.MusicfyGlanceWidget
import com.xelsoq.musicfy.ui.glancewidget.PlayerInfoStateDefinition
...
internal class WidgetUpdateManager(
    ...
    private companion object {
        ...
        // foreground Musicfy quickly; longer one coalesces incidental updates.
    ...
    private suspend fun updateGlanceWidgets(playerInfo: PlayerInfo) = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val glanceIds = glanceManager.getGlanceIds(MusicfyGlanceWidget::class.java)
            glanceIds.forEach { id ->
                updateAppWidgetState(context, PlayerInfoStateDefinition, id) { widgetPlayerInfo }
                MusicfyGlanceWidget().update(context, id)
            }
