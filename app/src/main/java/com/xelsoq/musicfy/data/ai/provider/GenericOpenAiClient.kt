package com.xelsoq.musicfy.data.ai.provider
    ...
    override suspend fun generateContent(
        ...
        return withContext(Dispatchers.IO) {
            ...
            if (providerName.equals("OpenRouter", ignoreCase = true)) {
                requestBuilder.addHeader("HTTP-Referer", "https://github.com/theovilardo/Musicfy")
                requestBuilder.addHeader("X-Title", "Musicfy")
            }
