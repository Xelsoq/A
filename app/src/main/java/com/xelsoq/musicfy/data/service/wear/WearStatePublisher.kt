...
import com.xelsoq.musicfy.shared.WearLyrics
...
class WearStatePublisher @Inject constructor(
    ...
    private fun resolveArtworkBytesForWear(playerInfo: PlayerInfo): ByteArray? {
        ...
        if (!uriString.isNullOrBlank()) {
            ...
            when {
                com.xelsoq.musicfy.utils.LocalArtworkUri.isLocalArtworkUri(uriString) ||
                    scheme == "content" ||
                    scheme == "file" ||
    ...
    private fun com.xelsoq.musicfy.data.model.Lyrics.toWearLyrics(
