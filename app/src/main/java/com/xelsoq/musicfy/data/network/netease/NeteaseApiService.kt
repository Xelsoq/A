package com.xelsoq.musicfy.data.network.netease
...
class NeteaseApiService @Inject constructor() {
    ...
    fun request(
        ...
        val builder = Request.Builder()
            ...
            .header("User-Agent", "Mozilla/5.0 (Linux; Android 14; Musicfy) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36")
