package com.xelsoq.musicfy.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.xelsoq.musicfy.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.xelsoq.musicfy.data.remote.qqmusic.QQSignGenerator(context)
        ))
