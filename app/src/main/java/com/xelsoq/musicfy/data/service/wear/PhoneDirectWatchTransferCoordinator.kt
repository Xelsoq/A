package com.xelsoq.musicfy.data.service.wear
...
import com.xelsoq.musicfy.data.gdrive.GDriveStreamProxy
...
import com.xelsoq.musicfy.data.telegram.TelegramStreamProxy
import com.xelsoq.musicfy.presentation.viewmodel.ColorSchemeProcessor
import com.xelsoq.musicfy.shared.WearDataPaths
import com.xelsoq.musicfy.shared.WearThemePalette
import com.xelsoq.musicfy.shared.WearTransferMetadata
import com.xelsoq.musicfy.shared.WearTransferProgress
import com.xelsoq.musicfy.shared.WearTransferRequest
...
class PhoneDirectWatchTransferCoordinator @Inject constructor(
    ...
    private suspend fun ensureCloudProxyReady(proxy: Any): Boolean {
        return when (proxy) {
            ...
            is com.xelsoq.musicfy.data.jellyfin.JellyfinStreamProxy -> proxy.ensureReady(5_000L)
            else -> false
        }
    }
