package com.xelsoq.musicfy.data.service.auto
...
class AutoMediaBrowseTree @Inject constructor(
    ...
    companion object {
        ...
        const val CONTEXT_TYPE_EXTRA = "com.xelsoq.musicfy.auto.extra.CONTEXT_TYPE"
        const val CONTEXT_ID_EXTRA = "com.xelsoq.musicfy.auto.extra.CONTEXT_ID"
        const val CONTEXT_PARENT_ID_EXTRA = "com.xelsoq.musicfy.auto.extra.CONTEXT_PARENT_ID"
    ...
    suspend fun getItem(mediaId: String): MediaItem? {
        return when {
            mediaId == ROOT_ID -> buildBrowsableItem(ROOT_ID, "Musicfy", null, MediaMetadata.MEDIA_TYPE_MUSIC)
