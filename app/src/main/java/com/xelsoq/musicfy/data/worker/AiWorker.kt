...
import com.xelsoq.musicfy.data.ai.AiNotificationManager
import com.xelsoq.musicfy.data.ai.AiHandler
import com.xelsoq.musicfy.data.ai.AiSystemPromptType
import com.xelsoq.musicfy.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.xelsoq.musicfy.data.preferences.AiPreferencesRepository
