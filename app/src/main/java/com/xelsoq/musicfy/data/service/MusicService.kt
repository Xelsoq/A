package com.xelsoq.musicfy.data.service
...
import com.xelsoq.musicfy.MainActivity
...
import com.xelsoq.musicfy.data.model.PlaybackQueueItemSnapshot
import com.xelsoq.musicfy.data.model.PlaybackQueueSnapshot
import com.xelsoq.musicfy.data.preferences.EqualizerPreferencesRepository
...
import com.xelsoq.musicfy.data.equalizer.EqualizerManager
import com.xelsoq.musicfy.data.model.WidgetThemeColors
import com.xelsoq.musicfy.data.preferences.AlbumArtColorAccuracy
import com.xelsoq.musicfy.data.preferences.AlbumArtPaletteStyle
import com.xelsoq.musicfy.presentation.viewmodel.ColorSchemeProcessor
...
import com.xelsoq.musicfy.di.AppScope
import com.xelsoq.musicfy.presentation.viewmodel.ListeningStatsTracker
...
suspend fun loadArtworkBytesViaCoil(context: Context, uri: Uri): ByteArray? {
    ...
    return runCatching {
        ...
        Timber.tag("MusicService_Musicfy").w(error, "Artwork read failed via Coil for uri=%s", uri)
        null
    }
}
...
class MusicService : MediaLibraryService() {
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.xelsoq.musicfy.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.xelsoq.musicfy.extra.FORCE_FOREGROUND_ON_START"
    ...
    override fun onCreate() {
        ...
        // through MusicfyMediaButtonReceiver), so the pending counter is only a hint. Promote
    ...
    private fun startTemporaryForegroundForCommand() {
        val notification = NotificationCompat.Builder(
            this,
            MusicfyApplication.NOTIFICATION_CHANNEL_ID
        )
    ...
    private val playerListener = object : Player.Listener {
        ...
        override fun onIsPlayingChanged(isPlaying: Boolean) {
            ...
            // Push state immediately so the watch can foreground Musicfy before
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.xelsoq.musicfy.data.model.QueueItem(
                            id = songId,
    ...
    public suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.xelsoq.musicfy.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
