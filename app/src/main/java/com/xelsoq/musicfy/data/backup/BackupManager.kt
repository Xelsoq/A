package com.xelsoq.musicfy.data.backup

import android.content.Context
import android.net.Uri
import android.os.Build
import com.xelsoq.musicfy.data.backup.format.BackupReader
import com.xelsoq.musicfy.data.backup.format.BackupWriter
import com.xelsoq.musicfy.data.backup.history.BackupHistoryRepository
import com.xelsoq.musicfy.data.backup.model.BackupHistoryEntry
import com.xelsoq.musicfy.data.backup.model.BackupManifest
...
import com.xelsoq.musicfy.data.backup.model.BackupValidationResult
import com.xelsoq.musicfy.data.backup.model.DeviceInfo
...
import com.xelsoq.musicfy.data.backup.restore.RestoreExecutor
import com.xelsoq.musicfy.data.backup.restore.RestorePlanner
import com.xelsoq.musicfy.data.backup.validation.ValidationPipeline
...
class BackupManager @Inject constructor(
    ...
    suspend fun export(
        ...
        runCatching {
            ...
            reportProgress(onProgress, BackupOperationType.EXPORT, ++step, totalSteps,
                "Backup complete", "Your Musicfy backup was created successfully.")
        }
    }
