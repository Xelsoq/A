...
import com.xelsoq.musicfy.data.database.FavoritesEntity
import com.xelsoq.musicfy.data.database.LyricsDao
import com.xelsoq.musicfy.data.database.LyricsEntity
import com.xelsoq.musicfy.data.database.SearchHistoryDao
import com.xelsoq.musicfy.data.database.SearchHistoryEntity
import com.xelsoq.musicfy.data.database.SongEngagementEntity
import com.xelsoq.musicfy.data.database.TransitionDao
import com.xelsoq.musicfy.data.database.TransitionRuleEntity
import com.xelsoq.musicfy.data.preferences.PreferenceBackupEntry
import com.xelsoq.musicfy.data.preferences.UserPreferencesRepository
import com.xelsoq.musicfy.data.stats.PlaybackStatsRepository
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Musicfy backup was created successfully."
            )
        }
    }
