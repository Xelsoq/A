package com.xelsoq.musicfy.data.navidrome.model

import okhttp3.HttpUrl
import okhttp3.HttpUrl.Companion.toHttpUrlOrNull
import com.xelsoq.musicfy.data.stream.CloudStreamSecurity
 ...
 * @property clientId The client identifier sent to the server (default: "Musicfy")
 */
data class NavidromeCredentials(
    val serverUrl: String,
    val username: String,
    val password: String,
    val clientId: String = "Musicfy"
) {
    companion object {
        /**
