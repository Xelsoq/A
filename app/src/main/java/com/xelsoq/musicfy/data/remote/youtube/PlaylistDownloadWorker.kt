...
import com.xelsoq.musicfy.data.database.youtube.AppDatabase
import com.xelsoq.musicfy.data.model.youtube.Song
import com.xelsoq.musicfy.data.model.youtube.PlaylistSongCrossRef
...
class PlaylistDownloadWorker(
    ...
    private suspend fun ensureYoutubeSongInLibrary(song: Song) {
        ...
        val artistsToInsert = artistNames.map { name ->
            com.xelsoq.musicfy.data.database.ArtistEntity(
        ...
        val crossRefsToInsert = artistNames.mapIndexed { index, name ->
            ...
            com.xelsoq.musicfy.data.database.SongArtistCrossRef(
                songId = songId,
                artistId = artistId,
                isPrimary = index == 0
            )
        ...
        val albumToInsert = com.xelsoq.musicfy.data.database.AlbumEntity(
            id = albumId,
            title = albumName,
        ...
        val songEntity = com.xelsoq.musicfy.data.database.SongEntity(
            id = songId,
            title = title,
            artistName = artist,
            artistId = primaryArtistId,
            ...
            sourceType = com.xelsoq.musicfy.data.database.SourceType.YOUTUBE
        )
