package com.xelsoq.musicfy.data.ai
...
import com.xelsoq.musicfy.data.database.AiCacheEntity
...
class AiHandler @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        suspend fun callWithModel(model: String): String {
            return try {
                ...
                throw com.xelsoq.musicfy.data.ai.provider.AiProviderSupport.createException(
        ...
        return try {
            ...
            val failure = com.xelsoq.musicfy.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.xelsoq.musicfy.data.ai.provider.AiClient,
        failure: com.xelsoq.musicfy.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.xelsoq.musicfy.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.xelsoq.musicfy.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.xelsoq.musicfy.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
