...
import com.xelsoq.musicfy.data.remote.youtube.UmihiHelper.printe
import com.xelsoq.musicfy.data.remote.youtube.UmihiHelper.printd
...
import com.xelsoq.musicfy.data.database.RelatedSongMap
...
import com.xelsoq.musicfy.presentation.viewmodel.ConnectivityStateHolder
...
object AutoQueueManager {
    ...
    private var engagementDaoRef: com.xelsoq.musicfy.data.database.EngagementDao? = null
    ...
    fun attach(
        ...
        musicDao: MusicDao,
        engagementDao: com.xelsoq.musicfy.data.database.EngagementDao,
    ...
    fun resetAndReseedFromCurrentSong() {
        ...
        currentScope.launch(Dispatchers.IO) {
            ...
            val (currentId, videoId) = withContext(Dispatchers.Main) {
                ...
                val metaUri = item.mediaMetadata?.extras?.getString("com.xelsoq.musicfy.external.CONTENT_URI")
    ...
    private suspend fun refillQueueLoop(currentId: String, forceRefresh: Boolean) {
        ...
        val metadataUriStr = currentMediaItem?.mediaMetadata?.extras?.getString("com.xelsoq.musicfy.external.CONTENT_URI")
