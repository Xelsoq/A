...
import com.xelsoq.musicfy.data.model.QueueItem
import com.xelsoq.musicfy.utils.createScalableBackgroundBitmap
import timber.log.Timber

class MusicfyGlanceWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        provideContent {
            ...
            Timber.tag("MusicfyGlanceWidget")
