...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.xelsoq.musicfy.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.xelsoq.musicfy.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.xelsoq.musicfy.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.xelsoq.musicfy.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.xelsoq.musicfy.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.xelsoq.musicfy.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.xelsoq.musicfy.ACTION_WIDGET_REPEAT"
}
