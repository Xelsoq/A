package com.xelsoq.musicfy.presentation.navigation

import DelimiterConfigScreen
import com.xelsoq.musicfy.presentation.screens.WordDelimiterConfigScreen
...
import com.xelsoq.musicfy.presentation.screens.EasterEggScreen
...
import com.xelsoq.musicfy.presentation.screens.AboutScreen
import com.xelsoq.musicfy.presentation.screens.OpenSourceLicensesScreen
import com.xelsoq.musicfy.presentation.screens.SearchScreen
import com.xelsoq.musicfy.presentation.screens.StatsScreen
import com.xelsoq.musicfy.presentation.screens.SettingsScreen
import com.xelsoq.musicfy.presentation.screens.SettingsCategoryScreen
import com.xelsoq.musicfy.presentation.screens.EqualizerScreen
...
import com.xelsoq.musicfy.presentation.components.ScreenWrapper
    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.xelsoq.musicfy.presentation.screens.DeviceCapabilitiesScreen(
                        navController = navController,
                        playerViewModel = playerViewModel
                    )
                }
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.xelsoq.musicfy.presentation.netease.dashboard.NeteaseDashboardScreen(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.xelsoq.musicfy.presentation.qqmusic.dashboard.QqMusicDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.xelsoq.musicfy.presentation.navidrome.dashboard.NavidromeDashboardScreen(
                        onBack = { navController.popBackStack() }
                    )
                }
            }
