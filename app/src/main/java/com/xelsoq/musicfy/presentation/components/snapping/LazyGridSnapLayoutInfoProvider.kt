package com.xelsoq.musicfy.presentation.components.snapping
...
/**
 * Ported from ArchiveTune's `ui/utils/LazyGridSnapLayoutInfoProvider.kt` so that
 * horizontal Quick Picks grids (LIST display mode) snap items to a centered
 * position the same way ArchiveTune's does, instead of free-scrolling.
 */
