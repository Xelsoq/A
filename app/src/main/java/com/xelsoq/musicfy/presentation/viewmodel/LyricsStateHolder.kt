...
import com.xelsoq.musicfy.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.xelsoq.musicfy.presentation.viewmodel.StablePlayerState>
    ) {
