...
import com.xelsoq.musicfy.data.media.ImageCacheManager
import com.xelsoq.musicfy.data.media.MetadataEditError
...
import com.xelsoq.musicfy.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.xelsoq.musicfy.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
