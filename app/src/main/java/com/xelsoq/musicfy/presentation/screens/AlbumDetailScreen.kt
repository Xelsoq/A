...
import com.xelsoq.musicfy.presentation.viewmodel.AlbumDetailViewModel
...
private fun CollapsingAlbumTopBar(
    ...
    val surfaceColor = MaterialTheme.colorScheme.surface
    val statusBarColor =
        if (LocalMusicfyDarkTheme.current) Color.Black.copy(alpha = 0.6f) else Color.White.copy(
            alpha = 0.4f
        )
