...
import com.xelsoq.musicfy.data.backup.BackupManager
...
import com.xelsoq.musicfy.data.backup.model.RestoreResult
import com.xelsoq.musicfy.data.backup.model.ValidationError
...
import com.xelsoq.musicfy.data.database.AiUsageEntity
...
import com.xelsoq.musicfy.data.ai.GeminiModel
import com.xelsoq.musicfy.data.ai.provider.AiClientFactory
import com.xelsoq.musicfy.data.ai.provider.AiProvider
import com.xelsoq.musicfy.data.preferences.LaunchTab
import com.xelsoq.musicfy.data.model.Song
import com.xelsoq.musicfy.data.service.player.HiFiCapabilityChecker
...
class SettingsViewModel @Inject constructor(
    ...
    private val geminiModelService: com.xelsoq.musicfy.data.ai.GeminiModelService,
            ...
            try {
                ...
                val models = if (provider == AiProvider.GEMINI) {
                    ...
                    aiClient.getAvailableModels(apiKey)
                        ...
                        .distinct()
                        .map { com.xelsoq.musicfy.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
                }
    ...
    fun setAlbumArtCacheLimitMb(limitMb: Int) {
        viewModelScope.launch {
            ...
            com.xelsoq.musicfy.utils.AlbumArtCacheManager.configuredCacheLimitMb = limitMb.toLong()
        }
    }
