...
import com.xelsoq.musicfy.data.database.AlbumArtThemeEntity
import com.xelsoq.musicfy.data.database.StoredColorSchemeValues
import com.xelsoq.musicfy.data.database.toComposeColor
import com.xelsoq.musicfy.utils.LocalArtworkUri
import com.xelsoq.musicfy.ui.theme.clearExtractedColorCache
import com.xelsoq.musicfy.ui.theme.extractSeedColor
import com.xelsoq.musicfy.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.xelsoq.musicfy.ui.theme.ColorExtractionConfig(
