package com.xelsoq.musicfy.baselineprofile
...
class PlayerSheetAnimationBenchmarks {
    ...
    private companion object {
        ...
        private val SHEET_COLLAPSED_PATTERN = pattern("Musicfy player sheet collapsed")
        private val SHEET_EXPANDED_PATTERN = pattern(
            "Musicfy player sheet expanded|Collapse player|Contraer reproductor|Now Playing|Reproduciendo"
        )
        private val COLLAPSED_PLAYER_ANCHOR_PATTERN = pattern(
            "Musicfy player sheet collapsed|Album art of|Car[aá]tula de|Anterior|Pausar|Reproducir|Siguiente"
        )
